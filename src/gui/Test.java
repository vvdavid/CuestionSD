...
public class Test extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("999,999");

        jLabel5.setText("999,999");

        jLabel6.setText("999,999");
        ...
        jTextArea1.setText("RangeSlider is a slider that can be used to select a range. A regular slider has only one thumb. So it can only be used to select one value. RangeSlider has two thumbs. Each one can be moved independently or both are moved together.\ngetLowValue() will return the value of low range and getHighValue() is the high range.");
